...
Follow **`executor-subtask-execution`** (`SKILL.md`). Log tier: **architectural**. Decision log: **`.dev/decision-logs/T12.md`**.
...
- **T2, T3, T4:** not consumed as upstream code artifacts for T1; execute after nothing.
