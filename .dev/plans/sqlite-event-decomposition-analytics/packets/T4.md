...
`(import_legacy_jsonl uses insert_event_row directly \| §2 Types / insert_event_row \| If T3 changes commit ownership (cursor vs connection), import may double-commit or not commit \| T4)` — **confirmed**
