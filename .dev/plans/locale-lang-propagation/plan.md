...
| Field | Value |
|-------|-------|
| **Handoff tree SHA** | `776c7969d6c386a79fda590c77cfe7f31fe3e613` (T8 — plan §8 + audit tracked; code chain `d0ce6d0` T5 → `344ca19d` T7 → `4739b325` T6) |
...
| **Checkout** | `git checkout 776c7969d6c386a79fda590c77cfe7f31fe3e613` — `plan.md` §8.1–§8.6 resolve via `git show` at closure SHA (remediates FIND-02/03); audit rev 1 at `.dev/audits/2026-05-22-locale-lang-propagation.md` (working tree / separate track) |
...
| Artifact | Path | `git show 776c7969d6c386a79fda590c77cfe7f31fe3e613:<path>` |
|----------|------|--------------------------------------|
...
| Same | **FIND-02/03** plan §8 not in SHA / hygiene | Commit plan v1.2.0 at closure SHA | **T8** | **remediated** — §8.1–§8.2 resolve via `git show 776c7969d6c386a79fda590c77cfe7f31fe3e613:plan.md` |
...
**v1.2.0 amendment verdict:** Surface 1 closed at `pipeline.py` and `gui/app.py` without changing Flag 2 hot-swap semantics. Amendment verification **146 passed** (§8.1). Re-audit recommended at `776c7969d6c386a79fda590c77cfe7f31fe3e613` against `.dev/audits/2026-05-22-locale-lang-propagation.md` rev 1 findings.
...
| **T8** | Landed @ `776c7969d6c386a79fda590c77cfe7f31fe3e613` — plan §8 + audit cross-link committed |
